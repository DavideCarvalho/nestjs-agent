// packages/dashboard/src/server/auth/session-cookie.ts
...
/** The session user the host's `login` hook returns to mint a cookie. */
 ...
 * `@dudousxd/nestjs-telescope`'s `dashboardAuth` cookie codec.
 */
